...
import ProductShelvesFiltersModal from './ProductShelvesFiltersModal';

const ProductShelvesFilters = ({
  onFilterChange,
  filters,
  paginate,
  applyFilters,
...
export default ProductShelvesFilters;
